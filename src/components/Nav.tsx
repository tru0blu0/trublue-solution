...
export default function Nav() {
  ...
  return (
    <>
      ...
      >
        {/* Logo */}
        <a href="#" className="flex items-center gap-3 group" aria-label={`${site.name} — home`}>
          ...
          >
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                className="font-display text-2xl font-bold text-navy hover:text-gold transition-colors"
